<?php
	error_reporting(0);
    class PDFReporteasistentes extends FPDF{  
            var $Conn;
            var $parametros;
            var $B;
            var $I;
            ...
            function PDFReporteasistentes($orientation='P',$unit='mm',$format='A4',$parametrosPDF){
        ...
        function Header(){              
            ...
            $this->SetX(80+$x);
            $this->Cell(80,10,utf8_decode("Reporte de Asistentes"),0,0,'L');
        ...
        // die();   
            ...
            while($row = mysql_fetch_assoc($dtDatos))
            {
                ...
                $this->SetFont('Arial','B',9);
                $this->SetX(10);
                $this->Cell(24,10,'Asistente :',0,0,'L'); 
                $this->SetX(50);
                $this->Cell(24,10,$GESTOR_DES,0,0,'L');                               
                $this->fila++;
                $count++;
                $this->Ln(7);       
